...
export { default as ParagraphStream } from "./paragraphStream"
export { default as LineStream } from "./lineStream"
export {
  isContinueLine,
  isFieldLine,
  parse,
...
export const VERSION = require("../package.json").version ?? 1.0
//----------------------------------------------------------------------
// end of index.coffee
